...
public class FileController {
    ...
    public String createResource(@RequestBody Base64PhotoFile data) {
        // Logic to save the newResource to a database or perform other operations
        // For demonstration, we'll just return the received resource
        ...
        if (base64Image.startsWith("data:image/jpeg;base64,")) {
            ...
            // Here you would typically save the decoded bytes to a file or database    
